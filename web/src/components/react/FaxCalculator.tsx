          ...
          <div className="w-full lg:w-1/2 flex flex-col space-y-6">
            ...
            {annualSavings > 1000000 && (
              <div className="mt-4 bg-slate-800 rounded-2xl p-6 text-center relative overflow-hidden group">
                ...
                <a href="#download-form" className="inline-flex w-full sm:w-auto items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-400 text-slate-900 font-bold py-3 px-8 rounded-full shadow-lg transition-transform transform hover:-translate-y-1">
                  FAX受注の自動化・事例集をDL
