            ...
            {annualSavings > 1000000 && (
              <div className="mt-4 bg-slate-800 rounded-2xl p-6 text-center relative overflow-hidden group">
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full justify-center items-center mt-2">
                  <a href="/slides/19_presentation.pdf" className="inline-flex w-full sm:w-auto items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-400 text-slate-900 font-bold py-3 px-8 rounded-full shadow-lg transition-transform transform hover:-translate-y-1">
                    FAX受注の自動化・事例集をDL
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
                  </a>
                  <a href="https://www.k-sp.co.jp/admin/std/contact/new" className="inline-flex w-full sm:w-auto items-center justify-center gap-2 bg-transparent hover:bg-white/10 text-white border-2 border-white/40 font-bold py-3 px-8 rounded-full transition-all">
                    無料で相談する
                  </a>
                </div>
              </div>
