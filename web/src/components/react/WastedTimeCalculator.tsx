            ...
            {totalAnnualLoss > 0 && (
              <div className="mt-4 bg-slate-800 rounded-2xl p-6 border border-slate-700 text-center relative overflow-hidden group">
                ...
                <div className="flex flex-col gap-3 w-full max-w-sm mx-auto mt-6">
                  ...
                  <a href="/slides/18_presentation.pdf" className="inline-flex w-full text-[14px] sm:text-base !text-white !no-underline items-center justify-center gap-2 bg-pink-600 hover:bg-pink-700 text-white font-bold py-3 px-8 rounded-full shadow-lg transition-transform transform hover:-translate-y-1">
                    上司説得用テンプレートをDL
