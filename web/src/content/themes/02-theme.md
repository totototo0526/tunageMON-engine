  ...
  - type: BlockFAQ
    ...
    items:
      - q: "AI-OCRで手書き文字はどこまで正確に読み取れますか？"
        a: "最新のAIモデルを使用しており、達筆な手書き文字でも95%以上の精度で読み取ります。万が一読み取れなかった部分は、画面上で元画像を見ながら簡単に修正できます。"
      - q: "現在使っている顧客管理システム(CRM)と連動できますか？"
        a: "はい、可能です。SalesforceやKintoneをはじめ、お客様が現在お使いのシステムに問い合わせ履歴やOCRで読み取ったデータを自動的に流し込みます。"
